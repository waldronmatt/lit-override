 ...
 */
export const addStyleSheetToElements = (elements: NodeListOf<Element> | Array<Element>, style: CSSResult): void => {
      ...
      if (name && name.includes('-')) {
        ...
        customElements.whenDefined(name).then(() => {
          if (supportsAdoptingStyleSheets) {
            ...
            (element as any).renderRoot.adoptedStyleSheets = [...(element as any).renderRoot.adoptedStyleSheets, style.styleSheet];
          } else {
